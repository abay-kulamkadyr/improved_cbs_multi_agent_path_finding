...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--instance", type=str, default=None, help="The name of the instance file(s)"
    )
    parser.add_argument(
        "--batch",
        action="store_true",
    ...
    parser.add_argument("--r", type=int, default=0, help="The number of repeats")
    parser.add_argument(
        "--solver",
        type=str,
        default=SOLVER,
        help="The solver to use (one of: {CBS,Independent,Prioritized}), defaults to "
        + str(SOLVER),
    )
    ...
    for file in sorted(glob.glob(args.instance)):
        ...
        for i in range(args.r):
            if args.solver == "CBS":
                ...
                time, expanded, generated, paths, h_ave = icbs.find_solution(
                    args.disjoint, args.h
                )
